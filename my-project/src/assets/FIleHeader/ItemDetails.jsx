...
//   // Calculate total tax values for AV and DV columns
//   const calculateTotalTax = () => {
//     const totalTaxAV = (itemDetails.isCustomDutySelected ? safeValue(itemDetails.customDuty) : 0) + 
//                       (itemDetails.isFtaCustomDutySelected ? safeValue(itemDetails.ftaCustomDuty) : 0) +
//                       safeValue(itemDetails.acd) + 
//                       safeValue(itemDetails.rd) + 
//                       safeValue(itemDetails.salesTax) + 
//                       safeValue(itemDetails.additionalSalesTax) + 
//                       safeValue(itemDetails.incomeTaxImport);

//     const totalTaxDV = totalTaxAV + 
//                       safeValue(itemDetails.furtherTax) + 
//                       safeValue(itemDetails.incomeTaxWithheld);

//     return { totalTaxAV, totalTaxDV };
//   };
...
//   const { totalTaxAV, totalTaxDV } = calculateTotalTax();
...
//         <div className="mb-6">
//           <div className="grid grid-cols-3 gap-4 mb-2 bg-gray-200 p-2 rounded">
//             <div className="text-sm font-bold text-gray-700">Name</div>
//             <div className="text-sm font-bold text-gray-700 text-center">Value AV</div>
//             <div className="text-sm font-bold text-gray-700 text-center">Value DV</div>
//           </div>
...
//                 type="radio"
//                 id="customDuty"
//                 checked={itemDetails.isCustomDutySelected}
...
//                 type="radio"
//                 id="ftaCustomDuty"
//                 checked={itemDetails.isFtaCustomDutySelected}
//                 onChange={() => handleDutyTypeChange('fta')}
//                 className="mr-2"
//               />
//               <label htmlFor="ftaCustomDuty" className="text-sm text-gray-700 mr-2">FTA Custom Duty (%)</label>
//               <input
//                 type="number"
//                 step="0.01"
...
//           <div className="grid grid-cols-3 gap-4 mb-2 items-center">
//             <div className="flex items-center">
//               <div className="text-sm text-gray-700 mr-2">ACD (%)</div>
//               <input
//                 type="number"
//                 step="0.01"
...
//           <div className="grid grid-cols-3 gap-4 mb-2 items-center">
//             <div className="flex items-center">
//               <div className="text-sm text-gray-700 mr-2">RD (%)</div>
//               <input
//                 type="number"
//                 step="0.01"
...
//           <div className="grid grid-cols-3 gap-4 mb-2 items-center">
//             <div className="flex items-center">
//               <div className="text-sm text-gray-700 mr-2">Sales Tax (%)</div>
//               <input
//                 type="number"
//                 step="0.01"
...
//           <div className="grid grid-cols-3 gap-4 mb-2 items-center">
//             <div className="flex items-center">
//               <div className="text-sm text-gray-700 mr-2">Additional Sales Tax (%)</div>
//               <input
//                 type="number"
//                 step="0.01"
...
//           <div className="grid grid-cols-3 gap-4 mb-2 items-center">
//             <div className="flex items-center">
//               <div className="text-sm text-gray-700 mr-2">Income Tax Import (%)</div>
//               <input
//                 type="number"
//                 step="0.01"
...
//                 type="number"
//                 step="0.01"
//                 value={totalTaxAV.toFixed(2)}
//                 disabled
//                 className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-100 font-bold"
//               />
//             </div>
//             <div>
//               <input
...
//           <div className="grid grid-cols-3 gap-4 mb-2 items-center">
//             <div className="flex items-center">
//               <div className="text-sm text-gray-700 mr-2">Further Tax (%)</div>
//               <input
//                 type="number"
//                 step="0.01"
...
//           <div className="grid grid-cols-3 gap-4 mb-2 items-center">
//             <div className="flex items-center">
//               <div className="text-sm text-gray-700 mr-2">Income Tax Withheld (%)</div>
//               <input
//                 type="number"
//                 step="0.01"
...
//                 type="number"
//                 step="0.01"
//                 value={safeValue(itemDetails.total)}
//                 disabled
//                 className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-100 font-bold"
//               />
//             </div>
...
//   // const [AV_forumla_value] = useState({
//   //   totalAvPkr : AvPkr,
//   //   customDuty : AvPkr * (itemDetails.customDuty) / 100,
//   //   ftaCustomDuty: AvPkr * (itemDetails.ftaCustomDuty) / 100,
//   //   acd : (AvPkr * itemDetails.acd) / 100,
//   //   rd: (totalAvPkr * itemDetails.rd) / 100,
//   //   salesTax : setSales_tex()

//   // })
//   // console.log(itemDetails.landedCost)

//   //  Value A.V

//   const AvPkr = exchangeRate * itemDetails.totalAssessableValue * landedCost
//   const DvPkr = exchangeRate * itemDetails.declaredValue * landedCost

//   const totalAvPkr = exchangeRate * itemDetails.totalAssessableValue * landedCost;
//   const Av_customDuty = (totalAvPkr * itemDetails.customDuty) / 100;
//   const Av_ftaCustomDuty = (totalAvPkr * itemDetails.ftaCustomDuty) / 100;
//   const Av_acd = (totalAvPkr * itemDetails.acd) / 100;
//   const Av_rd = (totalAvPkr * itemDetails.rd) / 100;
//   const Av_salesTax = ((totalAvPkr + Av_customDuty + Av_acd + Av_rd) * itemDetails.salesTax) / 100;
//   const Av_additionalSalesTax = ((totalAvPkr + Av_customDuty + Av_acd + Av_rd) * itemDetails.additionalSalesTax) / 100;
//   const Av_incomeTaxImport = ((totalAvPkr + Av_customDuty + Av_acd + Av_rd + Av_salesTax + Av_additionalSalesTax) * itemDetails.incomeTaxImport) / 100

//   const Av_GrandTotal = totalAvPkr + Av_acd + Av_additionalSalesTax + Av_customDuty + Av_ftaCustomDuty + Av_rd + Av_salesTax + Av_incomeTaxImport

//   const totalDvPkr = exchangeRate * itemDetails.declaredValue * landedCost;
//   const Dv_customDuty = totalDvPkr * (itemDetails.customDuty) / 100;
//   const Dv_ftaCustomDuty = totalDvPkr * (itemDetails.ftaCustomDuty) / 100;
//   const Dv_acd = (totalDvPkr * itemDetails.acd) / 100;
//   const Dv_rd = (totalDvPkr * itemDetails.rd) / 100;
//   const Dv_salesTax = ((totalDvPkr + Dv_customDuty + Dv_acd + Dv_rd) * itemDetails.salesTax) / 100;
//   const Dv_additionalSalesTax = ((totalDvPkr + Dv_customDuty + Dv_acd + Dv_rd) * itemDetails.additionalSalesTax) / 100;
//   const Dv_incomeTaxImport = ((totalDvPkr + Dv_customDuty + Dv_acd + Dv_rd + Dv_salesTax + Dv_additionalSalesTax) * itemDetails.incomeTaxImport) / 100

//   const Dv_GrandTotal = totalDvPkr + Dv_acd + Dv_additionalSalesTax + Dv_customDuty + Dv_ftaCustomDuty + Dv_rd + Dv_salesTax + Dv_incomeTaxImport

//   // console.log(itemDetails)
//   // console.log(itemDetails.acd)
//   // console.log(exchangeRate)
//   // console.log(totalAvPkr)
//   // console.log(ftaCustomDuty)
//   // console.log(acd)
...
//                 className="mr-2"
//               />
//               <label htmlFor="customDuty" className="text-sm text-gray-700 mr-2 w-32">Custom Duty (%)</label>
//               <input
//                 type="number"
//                 step="0.01"
//                 value={safeValue(itemDetails.customDuty)}
...
//                 className="mr-2"
//               />
//               <label htmlFor="ftaCustomDuty" className="text-sm text-gray-700 mr-2 w-32">FTA Custom Duty (%)</label>
//               <input
//                 type="number"
//                 step="0.01"
//                 value={safeValue(itemDetails.ftaCustomDuty)}
//                 onChange={(e) => onItemDetailChange('ftaCustomDuty', parseFloat(e.target.value) || 0)}
//                 className="flex-1 px-2 py-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 text-right focus:border-blue-500 text-right"
//                 disabled={!itemDetails.isFtaCustomDutySelected}
//               />
//             </div>
//             <div>
